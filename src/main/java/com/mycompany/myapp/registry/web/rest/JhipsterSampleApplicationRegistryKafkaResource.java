...
@RestController
@RequestMapping("/api/jhipster-sample-application-registry-kafka")
public class JhipsterSampleApplicationRegistryKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationRegistryKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplicationRegistryKafkaResource(KafkaProperties kafkaProperties) {

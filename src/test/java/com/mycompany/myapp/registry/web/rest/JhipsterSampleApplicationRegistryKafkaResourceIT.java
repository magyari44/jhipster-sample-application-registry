package com.mycompany.myapp.registry.web.rest;
...
import com.mycompany.myapp.registry.config.KafkaProperties;
...
class JhipsterSampleApplicationRegistryKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplicationRegistryKafkaResource kafkaResource = new JhipsterSampleApplicationRegistryKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-registry-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-registry-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
